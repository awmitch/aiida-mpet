# -*- coding: utf-8 -*-
"""Defines a `Parser` base class for `aiida-mpet`.

All `Parser` implementations in `aiida-mpet` must use this base class, not `aiida.parsers.Parser`.
"""
...
class Parser(_BaseParser):  # pylint: disable=abstract-method
    """Custom `Parser` class for `aiida-mpet` parser implementations."""
