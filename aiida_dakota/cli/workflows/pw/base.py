# -*- coding: utf-8 -*-
"""Command line scripts to launch a `StudyBaseWorkChain` for testing and demonstration purposes."""
import click
...
@cmd_launch.command('study-base')
@options_core.CODE(required=True, type=types.CodeParamType(entry_point='dakota.study'))
...
def launch_workflow(
    ...
    """Run a `StudyBaseWorkChain`."""
    from aiida.orm import Bool, Float, Dict
    from aiida.plugins import WorkflowFactory

    from aiida_dakota.utils.resources import get_default_options, get_automatic_parallelization_options

    builder = WorkflowFactory('dakota.study.base').get_builder()
    ...
    builder.study.parameters = Dict(dict=parameters)
    ...
    if automatic_parallelization:
        ...
        builder.study.metadata.options = get_default_options(max_num_machines, max_wallclock_seconds, with_mpi)
