# -*- coding: utf-8 -*-
"""Defines a `Parser` base class for `aiida-dakota`.

All `Parser` implementations in `aiida-dakota` must use this base class, not `aiida.parsers.Parser`.
"""
...
class Parser(_BaseParser):  # pylint: disable=abstract-method
    """Custom `Parser` class for `aiida-dakota` parser implementations."""
