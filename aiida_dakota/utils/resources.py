...
from aiida_dakota.utils.defaults.calculation import study as study_defaults
...
def get_study_parallelization_parameters(
    calculation,
    max_num_machines,
    target_time_seconds,
    ...
    """Guess optimal choice of parallelzation parameters for a StudyCalculation based on a completed initialization run.

    :param calculation: an initial study calculation (only initialization is sufficient),
    ...
    nsteps = electron_settings.get('electron_maxstep', study_defaults.electron_maxstep)
