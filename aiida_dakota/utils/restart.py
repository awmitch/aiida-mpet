...
from aiida_dakota.calculations.cp import CpCalculation
from aiida_dakota.calculations.neb import NebCalculation
from aiida_dakota.calculations.ph import PhCalculation
from aiida_dakota.calculations.study import StudyCalculation
...
def get_builder_restart(node, from_scratch=False, use_symlink=False):
    ...
    supported = (CpCalculation, NebCalculation, PhCalculation, StudyCalculation)
    ...
    if node.process_class in (CpCalculation, StudyCalculation):
