...
from aiida_dakota.calculations import BaseStudyInputGenerator


class StudyCalculation(BaseStudyInputGenerator):
    """`CalcJob` implementation for the dakota code of Dakota."""
    ...
    # Not using symlink in study to allow multiple nscf to run on top of the same scf
    ...
    def input_helper(cls, *args, **kwargs):
        ...
        This function calls :py:func:`aiida_dakota.calculations.helpers.study_input_helper`, see its docstring for
        further information.
        """
        from . import helpers
        return helpers.study_input_helper(*args, **kwargs)
